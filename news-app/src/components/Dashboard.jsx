  ...
  const fatchTopHeadline = async () => {
    try {
      const { data } = await axios.get(
        "https://newsapi.org/v2/everything?q=country=in&from=2024-02-29&sortBy=publishedAt&apiKey=3425a9c5d690483c8292113046210665"
      );
                ...
                <>
                  <div className="container mt-4 mb-4">
                    ...
                    <div className="d-flex align-items-center justify-content-center">
                      {item.urlToImage === null ? "Image Remove" : <></>}
                      <img
                        src={item.urlToImage}
                        alt={item.name}
